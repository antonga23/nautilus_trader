...
def test_best_bid_ask_uses_highest_executable_decimal_odds():
    orders = [
        {"isMakerBettingOutcomeOne": True, "percentageOdds": 5000},
        {"isMakerBettingOutcomeOne": True, "percentageOdds": 4000},
        {"isMakerBettingOutcomeOne": False, "percentageOdds": 5000},
        {"isMakerBettingOutcomeOne": False, "percentageOdds": 4000},
    ]
    ...
    http_client.get_order_book = AsyncMock(
        return_value={
            "data": {
                "orders": [
                    {"isMakerBettingOutcomeOne": True, "percentageOdds": 4000},
                    {"isMakerBettingOutcomeOne": False, "percentageOdds": 2500},
                ],
            },
        },
    )
