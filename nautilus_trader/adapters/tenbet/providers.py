...
# -------------------------------------------------------------------------------------------------
"""
10bet instrument provider using web scraping.
"""
...
class TenBetInstrumentProvider(InstrumentProvider):
    """
    Provides betting instruments from 10bet via web scraping.

    Uses Playwright to scrape market data from 10bet.co.za.
