...
class TenBetExecutionClient(LiveExecutionClient):
    """
    Execution client for 10bet using web scraping.
    ...
    Integrates with TenBetRiskEngine for rollover validation.
    ...
    def __init__(
        ...
        self._config = config
        self._account_id = AccountId(f"{TENBET_VENUE.value}-001")  # Placeholder
    ...
    async def _connect(self) -> None:
        ...
        self._log.info("TenBetExecutionClient connected")
