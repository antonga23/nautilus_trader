...
# -------------------------------------------------------------------------------------------------
"""
Blackbet adapter configuration.
"""
...
class BlackBetInstrumentProviderConfig(msgspec.Struct, frozen=True):
    """
    Configuration for `BlackBetInstrumentProvider`.

    Parameters
    ----------
    base_url : str, optional
        Base URL for blackbet website.
...
class BlackBetDataClientConfig(msgspec.Struct, frozen=True):
    """
    Configuration for `BlackBetDataClient`.

    Parameters
    ----------
    instrument_provider : BlackBetInstrumentProviderConfig, optional
    ...
    instrument_provider: BlackBetInstrumentProviderConfig | None = None
    base_url: str | None = None
    headless: bool = True
...
class BlackBetExecClientConfig(msgspec.Struct, frozen=True):
    """
    Configuration for `BlackBetExecutionClient`.
