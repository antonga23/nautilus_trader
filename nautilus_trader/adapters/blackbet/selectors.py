...
# -------------------------------------------------------------------------------------------------
"""
CSS selectors for blackbet web scraping.

NOTE: These selectors are fragile and will break when blackbet updates their website.
Regular maintenance required.

"""


class BlackBetSelectors:
    """
    CSS selectors and XPath expressions for blackbet.co.za.
    """
