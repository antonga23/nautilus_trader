...
class BlackBetVenueRiskPolicy(BettingVenueRiskPolicy):
    """
    Risk engine for blackbet venue.

    Implements blackbet-specific promotional terms:
    ...
    def __init__(
        ...
        super().__init__(venue_name="BLACKBET")

    def _initialize_rules(self) -> None:
        """
        Initialize blackbet-specific risk rules.
        """
        # Stake limits
        self.add_rule(
            StakeLimitRule(
...
BlackBetRiskEngine = BlackBetVenueRiskPolicy
