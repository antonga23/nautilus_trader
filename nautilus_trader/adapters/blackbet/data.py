...
# -------------------------------------------------------------------------------------------------
"""
Blackbet data client using web scraping.
"""
...
class BlackBetDataClient(LiveMarketDataClient):
    """
    Data client for blackbet using web scraping.
    ...
    async def _connect(self) -> None:
        ...
        """
        self._log.info("Connecting BlackBetDataClient...")
        await self._browser_client.connect()
        self._log.info("BlackBetDataClient connected")

    async def _disconnect(self) -> None:
        """
        Disconnect from blackbet.
        """
        self._log.info("Disconnecting BlackBetDataClient...")
        ...
        self._log.info("BlackBetDataClient disconnected")
