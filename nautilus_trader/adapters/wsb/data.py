...
# -------------------------------------------------------------------------------------------------
"""
WSB data client using web scraping.
"""
...
class WSBDataClient(LiveMarketDataClient):
    """
    Data client for WSB using web scraping.
    ...
    async def _connect(self) -> None:
        ...
        """
        self._log.info("Connecting WSBDataClient...")
        await self._browser_client.connect()
        self._log.info("WSBDataClient connected")

    async def _disconnect(self) -> None:
        """
        Disconnect from WSB.
        """
        self._log.info("Disconnecting WSBDataClient...")
        ...
        self._log.info("WSBDataClient disconnected")
