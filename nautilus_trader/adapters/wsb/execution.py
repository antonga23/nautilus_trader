...
# -------------------------------------------------------------------------------------------------
"""
WSB execution client using web scraping.
"""
...
class WSBExecutionClient(LiveExecutionClient):
    """
    Execution client for WSB using web scraping.
    ...
    def __init__(
        ...
        super().__init__(
            loop=loop,
            client_id=ClientId(WSB_VENUE.value),
            venue=WSB_VENUE,
        ...
        self._venue_risk_policy = WSBRiskEngine(
    ...
    async def _connect(self) -> None:
        """
        Connect to WSB (browser session).
        """
        self._log.info("Connecting WSBExecutionClient...")
        ...
        self._log.info("WSBExecutionClient connected")

    async def _disconnect(self) -> None:
        """
        Disconnect from WSB.
        """
        self._log.info("Disconnecting WSBExecutionClient...")
        await self._browser_client.disconnect()
        self._log.info("WSBExecutionClient disconnected")
    ...
    async def _cancel_order(self, command: CancelOrder) -> None:
        ...
        """
        self._log.warning("Order cancellation not supported for WSB")

    async def _modify_order(self, command: ModifyOrder) -> None:
        """
        Modify an order (not supported).
        """
        self._log.warning("Order modification not supported for WSB")
    ...
    async def generate_order_status_report(
        ...
        """
        self._log.warning(
            "Order status reports are not implemented for WSB "
