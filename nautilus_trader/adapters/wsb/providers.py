...
# -------------------------------------------------------------------------------------------------
"""
WSB instrument provider using web scraping.
"""
...
class WSBInstrumentProvider(InstrumentProvider):
    """
    Provides betting instruments from WSB via web scraping.

    Uses Playwright to scrape market data from WSB.co.za.
    ...
    def __init__(
        ...
        config: WSBInstrumentProviderConfig,
    ...
    async def load_all_async(self, filters: dict | None = None) -> None:
        ...
        """
        self._log.info("Loading instruments from WSB...")
    ...
    def load_all(self, filters: dict | None = None) -> None:
        """Provide synchronous load - not supported for async browser client."""
