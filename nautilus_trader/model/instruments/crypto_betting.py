...
class CryptoBettingInstrument(Instrument):
    ...
    def __init__(
        ...
        max_size: Union[float, Decimal, int],
        min_size: float,
        start_time: str,
        end_time: str,
        # ToDo: create enum for selection_side eg Back, Lay
        selection_side: str,
        event_name: str,
        # NB: event_id should be a unique per event but the same across all venues
        event_id: str,
        market_name: str,
        # NB: market_id should be a unique per event but the same across all venues
        market_id: str,
        # ToDo: create enum for venue eg cloudbet, betfair, etc
        venue_name: str,
        live: bool,
        # ToDo: create enum for trading_status eg TRADING, PRE-TRADING, SUSPENDED, etc
        trading_status: str,
        selection_name: str,
        fees: Optional[Any],
        ...
        self.selection_side = selection_side
