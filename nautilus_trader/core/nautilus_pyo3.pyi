...
class OpportunityGraphCore:
    ...
    def build_with_edges(self, nodes: Any, edges: Any) -> None: ...
    def load_semantic_templates(self, templates: Any) -> int: ...
    def load_semantic_coverage(self, proofs: Any, hyperedges: Any) -> tuple[int, int]: ...
    def build_semantic(self, nodes: Any, templates: Any) -> None: ...
    def add_instrument(self, node: Any) -> bool: ...
    def add_instrument_semantic(self, node: Any) -> bool: ...
    ...
    def semantic_coverage_summary_json(self) -> str: ...
    def edge_snapshots(
        self,
    ) -> list[
        tuple[
